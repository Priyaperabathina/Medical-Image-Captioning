...
const FileUpload = ({ username }) => {
  ...
  const setgeneratedText = (caption, prediction) => {
  ...
  const submitImage = async (e) => {
    ...
    try {
      ...
      const prediction = response.data.flaskResponse.prediction;
      console.log("Response from server:", caption, prediction);
      setgeneratedText(caption, prediction);
    } catch (error) {
